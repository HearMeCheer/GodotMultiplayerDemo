...
@onready var info_label: Label3D = $PlayerInfo/Info
...
func set_nick_color(color: Color):
	if nickname:
...
func get_camera_position() -> Vector3:
	return $SpringArmOffset/SpringArm3D/Camera3D.global_transform.origin

func get_camera_transform() -> Transform3D:
	return $SpringArmOffset/SpringArm3D/Camera3D.global_transform
